  ...
  return (
    <>
      ...
      <section className="relative py-8 md:py-12 bg-background">
        <div className="absolute inset-0" style={{ backgroundImage: `url(${quadriculadoMidiaBg})`, backgroundSize: '150%', backgroundPosition: 'left center', backgroundRepeat: 'repeat', opacity: 0.37 }} />
