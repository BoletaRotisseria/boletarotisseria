    ...
    subCategories: [
      {
        ...
        path: "/rotisserie",
        items: [
          { label: "Antipastos", path: "/rotisserie?categoria=antipastos" },
          { label: "Aperitivos", path: "/rotisserie?categoria=aperitivos" },
          { label: "Pães e Torradas", path: "/rotisserie?categoria=paes-e-torradas" },
          { label: "Saladas", path: "/rotisserie?categoria=saladas" },
          { label: "Empanadas", path: "/rotisserie?categoria=empanadas" },
          { label: "Veggie", path: "/rotisserie?categoria=veggie" },
          { label: "Carnes e Peixes", path: "/rotisserie?categoria=carne-peixe-e-frango" },
          { label: "Acompanhamentos", path: "/rotisserie?categoria=acompanhamentos" },
          { label: "Massas e Molhos", path: "/rotisserie?categoria=massas" },
          { label: "Pizza", path: "/rotisserie?categoria=pizza" },
          { label: "Tortas e Quiches", path: "/rotisserie?categoria=tortas-e-quiches" },
          { label: "Sopas e Caldos", path: "/rotisserie?categoria=sopas-e-caldos" },
      ...
      /*
      {
        ...
        items: [
          ...
          { label: "Azeites, Temperos & Especiais", path: "/emporio?categoria=azeites+temperos+e+especiais" },
        ],
      },
      {
        label: "Individual",
