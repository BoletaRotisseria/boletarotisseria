  ...
  return (
    <footer className="relative text-foreground">
      ...
      <div className="container relative z-10 py-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_2fr] gap-x-10 gap-y-6">
          {/* Coluna 1 – Logo + Sobre */}
          <div>
            <img src={casinhaAsset.url} alt="Boleta Rotisseria" className="h-44 w-auto mb-2 -ml-2" />
