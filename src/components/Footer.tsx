    ...
    <footer className="relative text-foreground">
      ...
      <div className="relative z-10 border-t border-b border-border/60 bg-background">
        <div className="container py-8 flex flex-col md:flex-row items-center gap-4 md:gap-8">
          ...
          <div className="flex w-full md:w-auto md:ml-auto shrink-0">
            <a
              href={WHATSAPP_CARDAPIO}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-foreground text-background px-8 py-3 font-sans text-xs font-bold tracking-[0.14em] uppercase transition-colors whitespace-nowrap hover:bg-foreground/90"
            >
