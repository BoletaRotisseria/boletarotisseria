  ...
  return (
    <footer className="relative text-foreground">
      ...
      <div className="relative z-10 border-b border-foreground/10">
        <div className="container flex flex-col md:flex-row items-center gap-6 md:gap-10 py-8">
          <p className="font-serif text-2xl tracking-[-0.02em] shrink-0 md:text-2xl">Receba o nosso cardápio semanal e fique por dentro das novidades.
          ...
          <div className="flex w-full md:w-auto md:ml-auto shrink-0 gap-0">
            <a
              ...
              className="inline-flex items-center gap-2.5 text-background px-8 py-3.5 font-sans text-xs font-bold tracking-[0.14em] uppercase transition-colors whitespace-nowrap bg-green-900">
